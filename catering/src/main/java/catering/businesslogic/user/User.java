...
public class User {
    ...
    public catering.businesslogic.event.Organizer asOrganizer() {
        return new catering.businesslogic.event.Organizer(this);
    }

    public catering.businesslogic.event.Chef asChef() {
        return new catering.businesslogic.event.Chef(this);
    }

    public catering.businesslogic.event.Cook asCook() {
        return new catering.businesslogic.event.Cook(this);
    }

    public catering.businesslogic.event.ServiceStaff asServiceStaff() {
        return new catering.businesslogic.event.ServiceStaff(this);
    }
